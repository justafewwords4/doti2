...
def github_dark():
	colors = [["#0d1117", "#0d1117"],  #background (dark) [0]
			   ...
			   ["#b3e5fc", "#b3e5fc"],  #secondary/blue [3] - matches BSPWM focused border
...
#rose_pine
def rose_pine():
	colors = [["#232136", "#232136"],  #background (base) [0]
			   ["#2a273f", "#2a273f"],  #background-alt (surface) [1]
			   ["#e0def4", "#e0def4"],  #foreground (text) [2]
			   ["#c4a7e7", "#c4a7e7"],  #iris (focused border/selection) [3]
			   ["#9ccfd8", "#9ccfd8"],  #foam (light blue/indicator) [4]
			   ["#6e6a86", "#6e6a86"],  #muted (disabled) [5]
			   ["#f6c177", "#f6c177"],  #gold (primary/orange) [6]
			   ["#ea9a97", "#ea9a97"],  #rose (pink) [7]
			   ["#2a273f", "#2a273f"],  #surface (border) [8]
			   ['#eb6f92', '#eb6f92'],  #love (red) [9]
			   ["#eb6f92", "#eb6f92"]]  #love (alert/urgent) [10]
			   
	backgroundColor = "#232136"
	foregroundColor = "#e0def4"
	workspaceColor = "#c4a7e7"
	foregroundColorTwo = "#9ccfd8"
	return colors, backgroundColor, foregroundColor, workspaceColor, foregroundColorTwo
